...
auc_savepath = 'D:/PycharmProjects/pythonProject/CapsNetYY1/onehot-roc.png'
coloer_list = ['b','orange','fuchsia','green','dimgray','khaki','mediumpurple','c','pink','rosybrown']

kfold = KFold(n_splits=10, shuffle=True, random_state=7)
names = ['HCT116',  'K562']
name=names[0]
seq1 = open_fa('D:/PycharmProjects/pythonProject/CapsNetYY1/feature encoding/one-hot/HCT116seq1train.txt')
seq1_onehot = onehot(seq1)
X_1=np.array(seq1_onehot)
seq2 = open_fa('D:/PycharmProjects/pythonProject/CapsNetYY1/feature encoding/one-hot/HCT116seq2train.txt')
seq2_onehot = onehot(seq2)
X_2=np.array(seq2_onehot)
y_tra= np.loadtxt('D:/PycharmProjects/pythonProject/CapsNetYY1/feature encoding/HCT116labeltrain.txt')
...
for i,(train, test) in enumerate(kfold.split(y_tra)):
    print('\n\n%d'%i)
    #print(i,(train,test))
    path = 'D:/PycharmProjects/pythonProject/CapsNetYY1/one-hot_h5/%sModel%d.h5' % (name, i)
