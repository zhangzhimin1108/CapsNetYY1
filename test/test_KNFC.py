...
from modelKNFC import get_model
...
model=get_model()
model.load_weights("D:/PycharmProjects/pythonProject/CapsNetYY1/mode_weight/HCT116_weight/HCT116Model_KNFC.h5")
...
for name in names:
    ...
    plt.plot(fpr, tpr, color=coloer_list[0], lw=lw, label='KNFC' + ' (AUC=%0.4f)' % auc_roc)
