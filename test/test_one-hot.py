...
from modelonehot import get_model
import numpy as np
import pandas as pd
...
auc_score = []
model=get_model()
model.load_weights("D:/PycharmProjects/pythonProject/CapsNetYY1/mode_weight/HCT116_weight/HCT116Model_onehot.h5")
names = ['HCT116']
...
for name in names:
    names = ['HCT116']
    name = names[0]
    seq1 = open_fa('D:/PycharmProjects/pythonProject/CapsNetYY1/feature encoding/one-hot/HCT116seq1test.txt')
    seq1_onehot = onehot(seq1)
    X_1 = np.array(seq1_onehot)
    seq2 = open_fa('D:/PycharmProjects/pythonProject/CapsNetYY1/feature encoding/one-hot/HCT116seq2test.txt')
    seq2_onehot = onehot(seq2)
    X_2 = np.array(seq2_onehot)
    y_tes_1 = np.loadtxt('D:/PycharmProjects/pythonProject/CapsNetYY1/feature encoding/HCT116labeltest.txt')
